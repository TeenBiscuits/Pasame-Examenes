...
export const es: Translations = {
  home: {
    ...
    archiveLabel: "Archivo de estudio",
    subjectCount: "{count} asignaturas",
    topicPractice: "Práctica por tema",
    examSimulation: "Simulación de examen",
    availableSubjects: "Asignaturas disponibles",
    subjectGridTitle: "Elige el montón que toca abrir hoy",
    sheetCallout: "Convocatoria",
    sheetStamp: "Repasar",
    sheetLineTopic: "Tema elegido",
    sheetLineMistakes: "Preguntas falladas",
    sheetLineTomorrow: "Volver mañana",
  },
  subjectHome: {
