...
export const es: Translations = {
	...
	settings: {
		...
		themesDescription: "Elige una paleta para cada esquema de color.",
		lightTheme: "Paleta clara",
		darkTheme: "Paleta oscura",
		...
		keyboardShortcutsDescription:
			"Personaliza los comandos de cada parte de la aplicación. Los cambios se guardan en este navegador.",
		resetShortcuts: "Restablecer todos",
		resetShortcut: "Restablecer este atajo",
		heldKeys: "Pulsadas",
		...
		shortcutConflict: "Este atajo entra en conflicto con otro comando.",
		shortcutConflictDescription:
			" Usa otra combinación para que cada atajo tenga un único destino.",
		shortcutHint: "Combinación de teclas",
		sequenceHint: "Secuencia · pulsa varias teclas",
		shortcutScopes: {
			global: "En toda la aplicación",
			practiceExam: "Tema y examen",
		},
		shortcutCommands: {
			"open-settings": "Abrir ajustes",
			"go-home": "Ir al inicio",
			"cycle-theme": "Cambiar la apariencia",
			"previous-question": "Pregunta anterior",
			"next-question": "Pregunta siguiente",
			"first-question": "Ir a la primera pregunta",
			"last-question": "Ir a la última pregunta",
			"check-question": "Comprobar pregunta",
			"clear-answer": "Borrar respuesta",
			"submit-session": "Enviar práctica / entregar examen",
			"start-exam": "Empezar examen",
			"answer-a": "Elegir opción A",
			"answer-b": "Elegir opción B",
			"answer-c": "Elegir opción C",
			"answer-d": "Elegir opción D",
	...
	practice: {
		...
		loadError: "No se han podido cargar las preguntas.",
		retry: "Reintentar",
