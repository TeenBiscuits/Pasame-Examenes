export const en = {
  home: {
    ...
    subjectGridTitle: "Choose the stack to open today",
    sheetCallout: "Session",
    sheetStamp: "Review",
    sheetLineTopic: "Chosen topic",
    sheetLineMistakes: "Missed questions",
    sheetLineTomorrow: "Come back tomorrow",
  },
  subjectHome: {
