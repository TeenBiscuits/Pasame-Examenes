export const en = {
	...
	settings: {
		...
		themesDescription: "Choose a palette for each color scheme.",
		lightTheme: "Light palette",
		darkTheme: "Dark palette",
		volume: "Sound volume",
		...
		keyboardShortcutsDescription:
			"Customize commands for each part of the app. Changes are saved in this browser.",
		resetShortcuts: "Reset all",
		resetShortcut: "Reset this shortcut",
		heldKeys: "Held",
		...
		shortcutConflict: "This shortcut conflicts with another command.",
		shortcutConflictDescription:
			" Choose another combination so each shortcut has one destination.",
		shortcutHint: "Key combination",
		sequenceHint: "Sequence · press several keys",
		shortcutScopes: {
			global: "Everywhere",
			practiceExam: "Topic and exam",
		},
		shortcutCommands: {
			...
			"first-question": "Go to first question",
			"last-question": "Go to last question",
			"check-question": "Check question",
			"clear-answer": "Clear answer",
			"submit-session": "Submit practice / exam",
			"start-exam": "Start exam",
			"answer-a": "Choose option A",
			"answer-b": "Choose option B",
			"answer-c": "Choose option C",
			"answer-d": "Choose option D",
	...
	practice: {
		...
		loadError: "We couldn't load the questions.",
		retry: "Try again",
