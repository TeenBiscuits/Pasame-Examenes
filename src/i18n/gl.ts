    ...
    privacySections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Preferencias locais: idioma seleccionado, tema seleccionado, volume dos sons da interface, fontes de preguntas seleccionadas, tours vistos, estado do popup de GitHub e materias visitadas recentemente.",
