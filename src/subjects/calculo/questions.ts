...
export const questions: Question[] = [
	...
	},
	{
		...
		options: ["A. 0 y -1", "B. -2 solamente", "C. -3 y -1", "D. no tiene"],
		correctAnswer: "c",
	},
	{
		id: "2025-07_q7",
...
Si giramos esta región alrededor del eje $X$ el volumen resultante será`,
		options: ["A. $\\pi(e - 2)$", "B. $\\pi e$", "C. $\\infty$", "D. $\\pi$"],
		correctAnswer: "a",
	},
	{
		id: "2025-07_q13",
...
Entonces, el valor de la solución en $x = \\frac{3\\pi}{2}$ es`,
	...
	},
	{
		...
		options: ["A. $L = e^{-6}$", "B. $L = e^{6}$", "C. L = 6", "D. L = -6"],
		correctAnswer: "a",
	},
	{
		id: "2024-07_q8",
	...
	},
	{
		...
		options: ["A. S = 2", "B. S = 4", "C. S = 0", "D. $S = \\frac{3}{2}$"],
		correctAnswer: "a",
	},
	{
		id: "2024-07_q10",
...
Sabiendo que el espacio es la integral de la velocidad respecto al tiempo, emplear la regla del trapecio compuesta para calcular el espacio recorrido por el objeto entre los tiempos $t = 2$ y $t = 9$ segundos.`,
	...
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "Si $ g(x) = \\sqrt{5 - x} $ y $ f = g \\circ g $, entonces",
		options: [
	...
	},
	{
		...
		options: ["A. a = 0", "B. $a^2 = 2$", "C. $a = \\pm 2$", "D. $a^2 = 1$"],
		correctAnswer: "d",
	},
	{
		id: "2024-01_q5",
	...
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "La función $ y = (x^{2} + 3x + 1)/(x^{2} + 1) $ tiene",
		options: [
	...
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "La función $f(x) = \\frac{5 \\cos(x) + x^2}{x - 3}$ tiene",
		options: [
	...
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "Sea $I = \\int_0^{\\frac{\\pi}{2}} \\tan(x) \\, dx$. Entonces",
		options: [
	...
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "Una solución de la EDO: $dx + e^{3x} dy = 0$, es",
		options: [
...
Las raíces de $f''$ son $x = 0$ y las de la bicuadrática $x^4 - 2x^2 - 3 = 0$: con $z = x^2$, $z^2 - 2z - 3 = 0 \\Rightarrow z = 3$ (el valor $z = -1$ no da raíces reales), es decir, $x = \\pm\\sqrt{3}$. Estudiando el signo de $f''$ en los cuatro subintervalos: $f$ es cóncava en $(-\\infty, -\\sqrt{3})$, convexa en $(-\\sqrt{3}, 0)$, cóncava en $(0, \\sqrt{3})$ y convexa en $(\\sqrt{3}, +\\infty)$.`,
	...
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "Sea $F(x) = \\int_{3x}^{x^2} \\frac{1}{t^3 + 1} dt$, entonces",
		options: [
			"A. $F'(x) = \\frac{1}{x^3 + 1}$",
			"C. $F'(x) = -\\frac{1}{x^3 + 1}$",
...
Con la condición $x(0) = 2$: $2 = 1 + C \\Rightarrow C = 1$, luego $x(t) = e^t + e^{-t^2/2}$.`,
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "¿Qué funciones $g$ son tales que $(3x^2 + 1)g'(x) = 3xg(x)$?",
		options: [
			"A. $g(x) = \\sqrt{3x^2 + 1} + C$",
			"C. $g(x) = x^3 + x + C$",
			"B. $g(x) = C(3x^2 + 1)^2$",
...
`,
	...
	},
	{
		...
		type: "mc",
		points: 0.5,
		question: "Si $f(x) = x^2 + 1$ y $g(x) = e^{x + 2}$, entonces",
		options: [
	...
	},
	{
		...
		points: 0.5,
		question:
			"Si $L = \\lim_{x \\to 0} \\frac{\\cos^2 x - 1}{1 + 2x - e^{2x}}$, entonces",
		options: [
			"A. $L = 1$",
			"B. $L = \\frac{1}{2}$",
			"C. $L = 0$",
	...
	},
	{
		...
		options: ["A. $A = 5/2$", "B. $A = 1/2$", "C. $A = 3/2$", "D. $A = 2$"],
		correctAnswer: "a",
	},
	{
		id: "2022-07_q15",
...
`,
	...
	},
	{
		...
		points: 0.5,
		question:
			"La solución general de la EDO $(1 + e^x) \\frac{dy}{dx} + e^x y = 0$ es",
		options: [
			"A. $y = 0$",
			"B. $y = \\frac{C}{1 + e^x}$",
			"C. $y = C$",
...

	{
		...
		points: 0.5,
		question:
			"La función inversa de $f(x) = \\ln \\left(\\sqrt[5]{x + 6}\\right)$ es",
		options: [
			"A. $f^{-1}(x) = e^{x / 5} - 6$",
			"B. $f^{-1}(x) = e^{x / 5} + 6$",
			"C. $f^{-1}(x) = e^{5x} - 6$",
...
El valor de a para que se cumpla el teorema del valor medio en $[0, 4]$ debe ser`,
	...
	},
	{
		...
		points: 0.5,
		question:
			"El área máxima de un triángulo rectángulo cuya hipotenusa mida 1 es",
