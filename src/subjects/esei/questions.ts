...
export const questions: Question[] = [
	...
	},
	{
		...
		type: "mc",
		points: 1,
		question: String.raw`Sea un dominio con tres manifestaciones posibles $\{M(1), M(2), M(3)\}$ y dos interpretaciones posibles $\{I(1), I(2)\}$. Desde una perspectiva categórica, y dadas las reglas del dominio:
    ...
    ¿Cuál de las siguientes combinaciones pertenece a la Base Lógica Reducida?`,
		...
		correctAnswer: "b",
		explanation: String.raw`Analizando la manifestación $m_4$, en la tabla dada sus valores son $M(1)=1, M(2)=0, M(3)=0$. Evaluemos cada opción:
...
| p(I1∧I2) | 0.38 |`,
	...
	},
	{
		...
		type: "mc",
		points: 1,
		question: String.raw`Dada la siguiente codificación de posibles Manifestaciones ($M$) e Interpretaciones ($I$) en un contexto de razonamiento categórico:
    ...
    **Tabla de Interpretaciones (I):**
    ...
    `,
		...
		correctAnswer: "a",
		explanation: String.raw`Analizamos lógicamente la manifestación entregada. La evidencia $f$ nos dice categóricamente que $M(1)$ es Verdadera ($1$), $M(2)$ es Falsa ($0$), y $M(3)$ es Falsa ($0$).
