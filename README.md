...
La plataforma es trilingüe (español, inglés, gallego) con un sistema de i18n propio en `src/i18n/`. Incluye apariencias clara y oscura, además de un modo sistema, conmutables desde la interfaz y aplicadas mediante `data-theme` en `<html>`.
